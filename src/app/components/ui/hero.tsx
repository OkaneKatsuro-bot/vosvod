...
export const Hero = () => {
    ...
    const slides = [
        ...
        {
            image: "/-ГИМС-3-e1691746560117.jpeg",
            title: "Профессиональное",
            words: ["обучение", "подготовка", "сопровождение", "аттестация"],
            subtitle: "от лучших инструкторов",
            address: "ул. Декабристов д.32/2 (Театральная площадь д.2)",
            phone: "+7 (931) 978-73-78"
        },
        {
            image: "/-ГИМС-1-e1691746637981.jpeg",
            title: "Быстрое получение",
            words: ["прав ГИМС", "удостоверений", "сертификатов", "лицензий"],
            subtitle: "с гарантией результата",
            address: "ул. Декабристов д.32/2 (Театральная площадь д.2)",
            phone: "+7 (931) 978-73-78"
        }
    ];
    ...
    return (
        <section className='relative w-full h-screen overflow-hidden'>
            ...
            {/* Основной контент - теперь на всю ширину */}
                ...
                >
                    ...
                    <div className="w-full mt-12 flex flex-col sm:flex-row gap-6 justify-center">
                        <Link href="/signup" className="w-full sm:w-auto">
                            <button className="w-full px-10 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-2xl font-bold transition-all transform hover:scale-105 shadow-xl hover:shadow-blue-500/30">
                                Записаться онлайн
                            </button>
                        </Link>
                        <Link href="/test" className="w-full sm:w-auto">
                            <button className="w-full px-10 py-5 bg-transparent border-2 border-white text-white hover:bg-white hover:text-black rounded-full text-2xl font-bold transition-all transform hover:scale-105">
                                Пройти тест
                            </button>
                        </Link>
                    </div>
