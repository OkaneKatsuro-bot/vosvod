      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
          ...
          <p className="text-lg text-white mb-4 max-w-2xl drop-shadow">
            Обучение машинистов автотранспорта с получением удостоверения на управление техникой
          </p>
          <Button
            onClick={openModal}
      ...
      <div className="space-y-10 max-w-7xl mx-auto px-4 py-16">
        ...
        <section className="bg-white p-6 rounded-2xl shadow-md mt-10">
          ...
          <div className="flex justify-center">
            ...
            >
              <source src="/Практика.mp4" type="video/mp4" />
            </video>
          </div>
        </section>
...
export default EquipmentLicensePage